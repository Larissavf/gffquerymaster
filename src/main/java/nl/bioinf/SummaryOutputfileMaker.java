...
public class SummaryOutputfileMaker {
     ...
     */
    static void typesOfAttributesPerFeature(StringBuilder sb, SummaryMaker summary) {
        sb.append("\n" +
     ...
     * @param summary SummaryMaker object containing all the collected information for the summary
     */
    static void averageAmountOfNucleotidesPerFeature(StringBuilder sb, SummaryMaker summary) {
        sb.append("\n" +
     ...
     * @param summary SummaryMaker object containing all the collected information for the summary
     */
    static void totalAmountOfFeaturesSB(StringBuilder sb, SummaryMaker summary) {
